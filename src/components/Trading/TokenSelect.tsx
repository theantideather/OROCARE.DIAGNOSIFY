  ...
  return (
    <div className="relative w-full">
      ...
      <button
        ...
        className="w-full px-2 sm:px-3 py-2 border-2 border-black rounded-lg bg-white
                 flex items-center justify-between gap-2 min-h-[40px] sm:min-h-[42px]
      ...
      {isOpen && (
        <div className="absolute z-10 w-full mt-1 bg-white border-2 border-black rounded-lg
                      shadow-lg max-h-[40vh] sm:max-h-[calc(100vh-200px)] overflow-auto">
              ...
              tokens.map((token) => (
                <button
                  ...
                  className="w-full flex items-center gap-2 px-2 py-1.5 hover:bg-gray-50
                           rounded text-left text-sm sm:text-base"
                >
                  {token.logoURI && (
                    <img 
                      src={token.logoURI}
